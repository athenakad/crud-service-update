...
#Optional endpoint just to check if FastAPI is up and InfluxDB is running
# @app.get("/health")
# def health():
#     try:
...
#             raise HTTPException(status_code=500, detail="InfluxDB not ready")
#         return {"status": "ok", "influxdb": "healthy"}
#     except Exception:
